...
user1 = User.create(email: 'hello@world.com', username: 'helloworld', password: 'helloworld')
...
appoint1 = Appointment.create(furniture_id:f1.id, user_id:user1.id,appoint_date: 2/8/2011)